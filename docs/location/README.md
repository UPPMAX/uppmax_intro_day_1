...
![Annotated map of Uppsala](uppsala_map_annotated_with_legend.png)
...
![BMC with entrance A4 annotated](bmc_a4_entrance_annotated.png)

Then go right, go right again at the end,
after which it is the first room at your right:

![BMC route annotated](bmc_route_annotated.png)
